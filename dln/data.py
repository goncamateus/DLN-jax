...
from dln.dataset import (
    DatasetFromFolderEval,
    DatasetFromFolder,
    Lowlight_DatasetFromVOC,
    Lowlight_DatasetFromVOCTest,
)
...
def get_Low_light_training_set(upscale_factor, patch_size, data_augmentation):
    return Lowlight_DatasetFromVOC(
        patch_size, upscale_factor, data_augmentation, transform=transform()
    )


def get_Low_light_test_set(upscale_factor, patch_size, data_augmentation):
    return Lowlight_DatasetFromVOCTest(
        patch_size, upscale_factor, data_augmentation, transform=transform()
    )
